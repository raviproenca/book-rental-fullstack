...
export const useRentersStore = defineStore('renters', () => {
  ...
  const registerRenter = async (renterData) => {
    ...
    try {
      ...
      error.value = err.response ? err.response.data.message : 'Erro ao registrar locatários.'
      throw err
    } finally {
      loading.value = false
    }
  ...
  const editRenter = async (renterId, renterData) => {
    ...
    try {
      ...
      error.value = err.response ? err.response.data.message : 'Erro ao editar locatários.'
      throw err
    } finally {
      loading.value = false
    }
  ...
  const deleteRenter = async (renterId) => {
    ...
    try {
      ...
      error.value = err.response ? err.response.data.message : 'Erro ao deletar locatários.'
      throw err
    } finally {
      loading.value = false
    }
